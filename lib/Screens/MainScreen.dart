                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text("Book A Ride ?", textAlign: TextAlign.center, style: TextStyle(color: Colors.white, fontSize: 18, fontFamily: GoogleFonts.openSans().fontFamily, fontWeight: FontWeight.bold))
                    ),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: (){
                        Navigator.pushNamed(context, '/BookedRides');
                      }, 
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Image(
                                ...
                                image: const AssetImage('Assets/Images/Booked.png')
                          ),  
                          SizedBox(width: screenHeight * .01),
                          Text("Booked Rides", style: TextStyle(color: const Color(0xff1E1E32), fontFamily: GoogleFonts.openSans().fontFamily)),
                        ],
                      )
                    ),
                  ),
