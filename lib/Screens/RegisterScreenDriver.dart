...
class _RegisterScreenDriverState extends State<RegisterScreenDriver> {
  ...
  final logger = getCustomLogger(RegisterScreenDriver);
  ...
  Future<bool> handleRegister() async {
    try{
      ...
      final userCredential = await firebaseAuth.createUserWithEmailAndPassword(
        email: "driver_${emailController.text}", 
        password: passwordController.text
      );
      await firebaseDatabase.child("drivers/${userCredential.user?.uid}").set({
                ...
                children: [
                    ...
                    onPressed: () async{
                      ...
                      if(formKey.currentState!.validate()){
                        if(await handleRegister()){
                          Navigator.pushNamed(context, "/MainScreenDriver");
                        }
                        else{
                          if(formKey.currentState!.validate()){
                            Navigator.pushNamed(context, "/MainScreenDriver");
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: (){
                          Navigator.popAndPushNamed(context, "/LoginDriver");
                        },
                        child: 
