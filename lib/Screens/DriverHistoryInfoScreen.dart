...
class DriverHistoryInfoScreen extends StatelessWidget {
  const DriverHistoryInfoScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    int statusNumber = 0;
    if(rideInfo['Status'] == 'Available'){statusNumber = 0;}
    else if(rideInfo['Status'] == 'Confirmed'){statusNumber = 1;}
    else if(rideInfo['Status'] == 'Started'){statusNumber = 2;}
    else if(rideInfo['Status'] == 'Arrived'){statusNumber = 3;}
    else if(rideInfo['Status'] == 'Completed'){statusNumber = 4;}
    else if(rideInfo['Status'] == 'Cancelled'){
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              generateStartTile(checkedStyle, 'Available', screenWidth, screenHeight, const Color(0xff10dbcf)),
                              generateMidTile(1, statusNumber, checkedStyle, 'Confirmed', screenWidth, screenHeight, const Color(0xff0ef1df)),
                              generateMidTile(2, statusNumber, checkedStyle, 'Started', screenWidth, screenHeight, const Color(0xff0af5ee)),
                              generateMidTile(3, statusNumber, checkedStyle, 'Arrived', screenWidth, screenHeight, const Color(0xff04e4f9)),
                              generateFinishTile(4, statusNumber, checkedStyle, 'Completed', screenWidth, screenHeight, const Color(0xff01d7fe)),
                            ],
                          ),
                        ),
                      ],
