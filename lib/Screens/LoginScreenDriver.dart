...
class _LoginScreenDriverState extends State<LoginScreenDriver> {
  ...
  final logger = getCustomLogger(LoginScreenDriver);
  ...
  Future<bool> handleLogin() async {
    ...
    await firebaseAuth.signInWithEmailAndPassword(
      email: "driver_${emailController.text}", password: passwordController.text);
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: (){
                          Navigator.popAndPushNamed(context, "/RegisterDriver");
                        },
                        child: 
